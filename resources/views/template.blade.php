...
<head>
	<title>Electro Store Ecommerce Category  | Electronics</title>
	<!-- Meta tag Keywords -->
		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						Sort By:<a href="sort" style="color: black;"> <b>Price Low to High</b>
						<!-- first section -->
								...
								<div class="row">
									<div class="col-md-4 product-men">
										<div class="men-pro-item simpleCart_shelfItem">
											...
											@foreach($data as $d)
											<img src="{{asset('images/'.$d->image)}}" alt="" width="300px" height="300px">
											...
											<div class="item-info-product text-center border-top mt-4">
												<h4 class="pt-1">
												<a href="{{route('product.show',$d->id)}}">{{$d->p_name}}</a>
												</h4>
					...
					<div class="side-bar p-sm-4 p-3">
						<div class="search-hotel border-bottom py-2">
							...
							<!-- @if(isset($_POST['start_price'])&& isset($_POST['end_price']))
								<form method="post" action="change1">
									@csrf
									@endif -->
							...
							<div class="left-side py-2">
								<ul>	
									...
									<li>
										...
										<input type="checkbox" class="checked" value="{{$b->id}}" id="brandId" name="brand[]">
										<span class="span">{{$b->cate_name}}</span>
									</li>
									@endforeach
								</ul>
						...
						<div class="range border-bottom py-2">
							...
							<p>
  							...
  							<input type="text" size="5" id="amount_start" name="start_price" value="<?php echo $selected_choice ?>"> : TO :
  							<input type="text" size="5" id="amount_end" name="end_price" value="<?php echo $select_choice ?>" >
							</p>
							<br> 
						...
						<div class="left-side border-bottom py-2">
							...
							<ul>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="5">
									<span class="span">5% or More</span>
								</li>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="10">
									<span class="span">10% or More</span>
								</li>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="20">
									<span class="span">20% or More</span>
								</li>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="30">
									<span class="span">30% or More</span>
								</li>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="50">
									<span class="span">50% or More</span>
								</li>
								<li>
									<input type="checkbox" class="checked" name="discount[]" value="60">
