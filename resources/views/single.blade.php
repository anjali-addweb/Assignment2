		...
		<div class="container py-xl-4 py-lg-2">
			...
			<div class="row">
					...
					<div class="grid images_3_of_2">
						<div class="flexslider">
							<ul class="slides">
								...
								@foreach($color as $c)
								<a href="{{route('product.show',$c->id)}}"><li data-thumb="{{asset('images/'.$c->image)}}" width="140px" height="140px" >
									<div class="thumb-image">	
										<img src="{{asset('images/'.$c->image)}}" width="437px" height="437px" data-imagezoom="true" class="img-fluid" alt="">
										@endforeach 
									</div>
								</li>
				...
				<div class="col-lg-7 single-right-left simpleCart_shelfItem">
					<h3 class="mb-3">{{$data->p_name}}</h3>
					<p class="mb-3" style="color: black;">
						<del class="mx-2 font-weight-light">₹{{$data->price}}</del>
						...
						<h2 style="color: black;">color:-{{$data->color}}</h2>
					...
					<div class="product-single-w3l" style="color: black;">
						<p class="my-3">
